...
- **Groups**: notes can be organized under nested, folder-like groups, a
  database-only relationship (`notes.group_id` / `groups.parent_id`) with no
  frontmatter representation. See [groups.md](architecture/groups.md).
